    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="text-center mb-12">
          ...
          {/* Hero: GLB model reference images generated by ChatGPT */}
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <div className="relative group rounded-xl border border-border-github overflow-hidden shadow-sm bg-code-bg">
              <Image
                src="/images/3d-village-one.png"
                alt="3D Village GLB model - front view"
                width={480}
                height={360}
                className="w-full h-auto object-cover"
                priority
              />
              <div className="absolute bottom-2 left-2 px-2 py-0.5 rounded bg-black/60 text-white text-[10px] font-mono backdrop-blur-sm">
                view 1 — village.glb
              </div>
            </div>
            <div className="relative group rounded-xl border border-border-github overflow-hidden shadow-sm bg-code-bg">
              <Image
                src="/images/3d-village-two.png"
                alt="3D Village GLB model - angle view"
                width={480}
                height={360}
                className="w-full h-auto object-cover"
                priority
          ...
          <p className="mt-3 text-xs text-foreground/40 font-mono">
            AI-generated reference images from the exported .glb model
          </p>
        </section>
